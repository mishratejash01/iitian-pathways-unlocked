  ...
  const timelineData = [
    {
      ...
      content: (
        <div className="space-y-6">
          ...
          <div className="mb-8">
            <h5 className="text-lg font-semibold text-gray-800 mb-4">Mid-Year Milestone</h5>
          ...
          <div className="mb-6">
            <h5 className="text-lg font-semibold text-gray-800 mb-4">End of Year Achievement</h5>
            <div className="space-y-3 text-gray-600">
    ...
    },
    {
      ...
      content: (
        <div className="space-y-6">
          ...
          <div className="mb-8">
            <h5 className="text-lg font-semibold text-gray-800 mb-4">Early 2025 - Global Outreach</h5>
            <div className="space-y-3 text-gray-600">
          ...
          <div className="mb-8">
            <h5 className="text-lg font-semibold text-gray-800 mb-4">Key Launches</h5>
            <div className="space-y-3 text-gray-600">
          ...
          <div className="mb-8">
            <h5 className="text-lg font-semibold text-gray-800 mb-4">Mid-2025 - Major Expansion</h5>
            <div className="space-y-3 text-gray-600">
    ...
    },
    {
      ...
      content: (
        <div className="space-y-6">
          ...
          <div className="mb-8">
            <h5 className="text-lg font-semibold text-gray-800 mb-4">Educational Excellence</h5>
            <div className="space-y-3 text-gray-600">
          ...
          <div className="mb-8">
            <h5 className="text-lg font-semibold text-gray-800 mb-4">Career & Placement Support</h5>
            <div className="space-y-3 text-gray-600">
          ...
          <div className="mb-8">
            <h5 className="text-lg font-semibold text-gray-800 mb-4">Entrepreneurship & Innovation</h5>
            <div className="space-y-3 text-gray-600">
          ...
          <div className="mb-6">
            <h5 className="text-lg font-semibold text-gray-800 mb-4">Long-term Impact</h5>
            <div className="space-y-3 text-gray-600">
  ...
  return (
    <>
      ...
      <main className="pt-20">
        {/* Hero Section */}
        <section className="bg-gradient-to-r from-royal to-royal-dark text-white py-20">
        ...
        <section className="py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-bold text-gray-900 mb-4 text-center">Journey of Unknown IITians</h2>
